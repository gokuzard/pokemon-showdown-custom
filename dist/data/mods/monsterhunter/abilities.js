...
const Abilities = {
    ...
    onDamagingHit(damage, target, source, move) {
      ...
      if (this.dex.getEffectiveness(move.type, target) > 0) {
        this.boost(
          ...
          target,
          null
          /* , this.dex.abilities.get('blindrage') */
        );
  ...
  corrosiveclaws: {
    ...
    desc: "When this Pok\xE9mon brings an opponent to 50% HP or less with an attacking move, it badly poisons that opponent.",
  ...
  corruptedpoison: {
      ...
      if (move.category === "Physical") {
        if (target.boosts.def > -6) {
          this.boost(
            ...
            source,
            null
            /* , this.dex.abilities.get('corruptedpoison') */
          );
    ...
    desc: "When this Pok\xE9mon hits a foe with a non-resisted Poison-type attack, that foe's corresponding defense is lowered by 1 stage, unless the foe is holding a Covert Cloak.",
  ...
  crystalblight: {
    ...
    flags: {},
    name: "Crystalblight",
    desc: "At the end of each turn, opposing Pok\xE9mon that are paralyzed take 1/16 of their max HP as damage and become Fatigued.",
    ...
    onSourceHit(target, source, move) {
      ...
      if (move.flags["slicing"]) {
        this.boost(
          ...
          source,
          null
          /* , this.dex.abilities.get('dulledblades') */
        );
  ...
  geminicore: {
    ...
    name: "Gemini Core",
    desc: "This Pok\xE9mon ignores charging and recharging turns on its moves.",
  ...
  howlingthunder: {
    ...
    desc: "When this Pok\xE9mon is under the effect of Charge, its Attack is doubled and its Speed is multiplied by 1.5x.",
  ...
  mightywall: {
    ...
    name: "Mighty Wall",
    shortDesc: "On switch-in: This Pok\xE9mon takes 0.5x damage from attacks."
  },
  mucusveil: {
  ...
  pathogenic: {
    ...
    flags: {},
    name: "Pathogenic",
    shortDesc: "Hit by contact moves: Attacker's ability becomes Pathogenic; non-Poison Pok\xE9mon lose 1/8 HP per turn."
  },
  perforating: {
  ...
  ragingrebel: {
    ...
    flags: {},
    name: "Raging Rebel",
    shortDesc: "This Pok\xE9mon & allies: 1.3x damage when any foe has stat drops; Attack can't be lowered."
  },
  reactivecore: {
    onDamagingHit(damage, target, source, move) {
      if (move.type === "Fire") {
  ...
  risenburst: {
    ...
    onDamagingHit(damage, target, source, move) {
      if (
        /* !move.noreact && */
        target.hp && source.hp && move.type === "Dark"
      ) {
        const reaction = this.dex.getActiveMove("risenburst");
  ...
  rustedgale: {
    ...
    flags: {},
    name: "Rusted Gale",
    desc: "Steel-types without this Ability gain the Rusted volatile immediately when it activates or when they switch in. Other Pok\xE9mon have their Defense reduced to 0.75x. All effects end when the holder leaves the field.",
  ...
  starvingbite: {
    ...
    flags: {},
    name: "Starving Bite",
    desc: "This Pok\xE9mon's biting attacks ignore target abilities and type immunities, but still respect resistances and weaknesses.",
  ...
  strafe: {
    ...
    flags: {},
    name: "Strafe",
    desc: "When this Pok\xE9mon takes damage, 20% of its Speed stat is added to its Defense and Special Defense.",
  ...
  wyversion: {
    ...
    flags: {},
    name: "Wyversion",
    desc: "Flame Orb, Frost Orb, and Toxic Orb are consumed after they trigger. When hit or inflicted with a non-Sleep status, this Pok\xE9mon cures the status and gains Dragon Charge, boosting its next Dragon-type move. While charged, it cannot be inflicted with status except Sleep.",
